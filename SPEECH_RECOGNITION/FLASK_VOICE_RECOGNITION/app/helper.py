...
def decode_and_create_audio(audio):
...
def decode_and_create_audio_with_username(audio, username):
    unique_filename = str(uuid.uuid4())
    decode_string = base64.b64decode(audio)
...
def decode_and_create_audio_biometric_recognize(audio):
    ...
    reduceAudio('last_biometric_audio_tested')
